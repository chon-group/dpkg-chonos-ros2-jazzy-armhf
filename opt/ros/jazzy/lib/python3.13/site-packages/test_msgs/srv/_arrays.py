...
class Metaclass_Arrays_Request(type):
    """Metaclass of message 'Arrays_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arrays__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arrays__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arrays__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arrays__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arrays__request
...
class Arrays_Request(metaclass=Metaclass_Arrays_Request):
    """Message class 'Arrays_Request'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.bool_values_default = kwargs.get(
            'bool_values_default', Arrays_Request.BOOL_VALUES_DEFAULT__DEFAULT)
        self.byte_values_default = kwargs.get(
            'byte_values_default', Arrays_Request.BYTE_VALUES_DEFAULT__DEFAULT)
        self.char_values_default = kwargs.get(
            'char_values_default', Arrays_Request.CHAR_VALUES_DEFAULT__DEFAULT)
        self.float32_values_default = kwargs.get(
            'float32_values_default', Arrays_Request.FLOAT32_VALUES_DEFAULT__DEFAULT)
        self.float64_values_default = kwargs.get(
            'float64_values_default', Arrays_Request.FLOAT64_VALUES_DEFAULT__DEFAULT)
        self.int8_values_default = kwargs.get(
            'int8_values_default', Arrays_Request.INT8_VALUES_DEFAULT__DEFAULT)
        self.uint8_values_default = kwargs.get(
            'uint8_values_default', Arrays_Request.UINT8_VALUES_DEFAULT__DEFAULT)
        self.int16_values_default = kwargs.get(
            'int16_values_default', Arrays_Request.INT16_VALUES_DEFAULT__DEFAULT)
        self.uint16_values_default = kwargs.get(
            'uint16_values_default', Arrays_Request.UINT16_VALUES_DEFAULT__DEFAULT)
        self.int32_values_default = kwargs.get(
            'int32_values_default', Arrays_Request.INT32_VALUES_DEFAULT__DEFAULT)
        self.uint32_values_default = kwargs.get(
            'uint32_values_default', Arrays_Request.UINT32_VALUES_DEFAULT__DEFAULT)
        self.int64_values_default = kwargs.get(
            'int64_values_default', Arrays_Request.INT64_VALUES_DEFAULT__DEFAULT)
        self.uint64_values_default = kwargs.get(
            'uint64_values_default', Arrays_Request.UINT64_VALUES_DEFAULT__DEFAULT)
        self.string_values_default = kwargs.get(
            'string_values_default', Arrays_Request.STRING_VALUES_DEFAULT__DEFAULT)
    ...
    def __eq__(self, other):
        ...
        if self.byte_values != other.byte_values:
            return False
        if any(self.char_values != other.char_values):
            return False
        if any(self.float32_values != other.float32_values):
            return False
        if any(self.float64_values != other.float64_values):
            return False
        if any(self.int8_values != other.int8_values):
            return False
        if any(self.uint8_values != other.uint8_values):
            return False
        if any(self.int16_values != other.int16_values):
            return False
        if any(self.uint16_values != other.uint16_values):
            return False
        if any(self.int32_values != other.int32_values):
            return False
        if any(self.uint32_values != other.uint32_values):
            return False
        if any(self.int64_values != other.int64_values):
            return False
        if any(self.uint64_values != other.uint64_values):
            return False
        ...
        if self.byte_values_default != other.byte_values_default:
            return False
        if any(self.char_values_default != other.char_values_default):
            return False
        if any(self.float32_values_default != other.float32_values_default):
            return False
        if any(self.float64_values_default != other.float64_values_default):
            return False
        if any(self.int8_values_default != other.int8_values_default):
            return False
        if any(self.uint8_values_default != other.uint8_values_default):
            return False
        if any(self.int16_values_default != other.int16_values_default):
            return False
        if any(self.uint16_values_default != other.uint16_values_default):
            return False
        if any(self.int32_values_default != other.int32_values_default):
            return False
        if any(self.uint32_values_default != other.uint32_values_default):
            return False
        if any(self.int64_values_default != other.int64_values_default):
            return False
        if any(self.uint64_values_default != other.uint64_values_default):
            return False
...
class Metaclass_Arrays_Response(type):
    """Metaclass of message 'Arrays_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arrays__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arrays__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arrays__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arrays__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arrays__response
...
class Arrays_Response(metaclass=Metaclass_Arrays_Response):
    """Message class 'Arrays_Response'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.bool_values_default = kwargs.get(
            'bool_values_default', Arrays_Response.BOOL_VALUES_DEFAULT__DEFAULT)
        self.byte_values_default = kwargs.get(
            'byte_values_default', Arrays_Response.BYTE_VALUES_DEFAULT__DEFAULT)
        self.char_values_default = kwargs.get(
            'char_values_default', Arrays_Response.CHAR_VALUES_DEFAULT__DEFAULT)
        self.float32_values_default = kwargs.get(
            'float32_values_default', Arrays_Response.FLOAT32_VALUES_DEFAULT__DEFAULT)
        self.float64_values_default = kwargs.get(
            'float64_values_default', Arrays_Response.FLOAT64_VALUES_DEFAULT__DEFAULT)
        self.int8_values_default = kwargs.get(
            'int8_values_default', Arrays_Response.INT8_VALUES_DEFAULT__DEFAULT)
        self.uint8_values_default = kwargs.get(
            'uint8_values_default', Arrays_Response.UINT8_VALUES_DEFAULT__DEFAULT)
        self.int16_values_default = kwargs.get(
            'int16_values_default', Arrays_Response.INT16_VALUES_DEFAULT__DEFAULT)
        self.uint16_values_default = kwargs.get(
            'uint16_values_default', Arrays_Response.UINT16_VALUES_DEFAULT__DEFAULT)
        self.int32_values_default = kwargs.get(
            'int32_values_default', Arrays_Response.INT32_VALUES_DEFAULT__DEFAULT)
        self.uint32_values_default = kwargs.get(
            'uint32_values_default', Arrays_Response.UINT32_VALUES_DEFAULT__DEFAULT)
        self.int64_values_default = kwargs.get(
            'int64_values_default', Arrays_Response.INT64_VALUES_DEFAULT__DEFAULT)
        self.uint64_values_default = kwargs.get(
            'uint64_values_default', Arrays_Response.UINT64_VALUES_DEFAULT__DEFAULT)
        self.string_values_default = kwargs.get(
            'string_values_default', Arrays_Response.STRING_VALUES_DEFAULT__DEFAULT)
...
class Metaclass_Arrays_Event(type):
    """Metaclass of message 'Arrays_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'test_msgs.srv.Arrays_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arrays__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arrays__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arrays__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arrays__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arrays__event
...
class Arrays_Event(metaclass=Metaclass_Arrays_Event):
    """Message class 'Arrays_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<test_msgs/Arrays_Request, 1>',
        'response': 'sequence<test_msgs/Arrays_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['test_msgs', 'srv'], 'Arrays_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['test_msgs', 'srv'], 'Arrays_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from test_msgs.srv import Arrays_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Arrays_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Arrays_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from test_msgs.srv import Arrays_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Arrays_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Arrays_Response'"
        self._response = value


class Metaclass_Arrays(type):
    """Metaclass of service 'Arrays'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._TYPE_SUPPORT = module.type_support_srv__srv__arrays

            from test_msgs.srv import _arrays
            if _arrays.Metaclass_Arrays_Request._TYPE_SUPPORT is None:
                _arrays.Metaclass_Arrays_Request.__import_type_support__()
            if _arrays.Metaclass_Arrays_Response._TYPE_SUPPORT is None:
                _arrays.Metaclass_Arrays_Response.__import_type_support__()
            if _arrays.Metaclass_Arrays_Event._TYPE_SUPPORT is None:
                _arrays.Metaclass_Arrays_Event.__import_type_support__()


class Arrays(metaclass=Metaclass_Arrays):
    from test_msgs.srv._arrays import Arrays_Request as Request
    from test_msgs.srv._arrays import Arrays_Response as Response
    from test_msgs.srv._arrays import Arrays_Event as Event
