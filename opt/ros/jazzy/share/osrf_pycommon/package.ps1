...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/osrf_pycommon/hook/ld_library_path_lib.ps1"
...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/osrf_pycommon/hook/pythonscriptspath.ps1"
