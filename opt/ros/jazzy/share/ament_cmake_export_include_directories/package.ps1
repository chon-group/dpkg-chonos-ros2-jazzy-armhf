...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/ament_cmake_export_include_directories/hook/ld_library_path_lib.ps1"
...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/ament_cmake_export_include_directories/hook/pythonscriptspath.ps1"
