...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/rmw_implementation/hook/cmake_prefix_path.ps1"
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX/share/rmw_implementation/hook/ld_library_path_lib.ps1"
