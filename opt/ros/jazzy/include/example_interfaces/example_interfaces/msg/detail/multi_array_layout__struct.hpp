...
// IWYU pragma: private, include "example_interfaces/msg/multi_array_layout.hpp"
...
struct MultiArrayLayout_
{
  ...
  using _dim_type =
    std::vector<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>>>;
  _dim_type dim;
  ...
  Type & set__dim(
    const std::vector<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::msg::MultiArrayDimension_<ContainerAllocator>>> & _arg)
  {
    this->dim = _arg;
    return *this;
  }
