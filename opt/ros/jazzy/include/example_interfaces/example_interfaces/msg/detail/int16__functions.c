...
example_interfaces__msg__Int16__Sequence__init(example_interfaces__msg__Int16__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(example_interfaces__msg__Int16)) {
      return false;
    }
  ...
  example_interfaces__msg__Int16__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(example_interfaces__msg__Int16)) {
      return false;
    }
    ...
    example_interfaces__msg__Int16 * data =
      (example_interfaces__msg__Int16 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!example_interfaces__msg__Int16__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          example_interfaces__msg__Int16__fini(&output->data[i]);
        }
        return false;
      }
    }
