...
example_interfaces__msg__UInt8MultiArray__create(void)
{
...
example_interfaces__msg__UInt8MultiArray__Sequence__init(example_interfaces__msg__UInt8MultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(example_interfaces__msg__UInt8MultiArray)) {
      return false;
    }
  ...
  example_interfaces__msg__UInt8MultiArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(example_interfaces__msg__UInt8MultiArray)) {
      return false;
    }
