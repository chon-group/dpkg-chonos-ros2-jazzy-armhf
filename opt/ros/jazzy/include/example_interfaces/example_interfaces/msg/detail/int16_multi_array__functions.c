...
example_interfaces__msg__Int16MultiArray__Sequence__init(example_interfaces__msg__Int16MultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(example_interfaces__msg__Int16MultiArray)) {
      return false;
    }
    data = (example_interfaces__msg__Int16MultiArray *)allocator.zero_allocate(size, sizeof(example_interfaces__msg__Int16MultiArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  example_interfaces__msg__Int16MultiArray__Sequence * array = (example_interfaces__msg__Int16MultiArray__Sequence *)allocator.allocate(sizeof(example_interfaces__msg__Int16MultiArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  example_interfaces__msg__Int16MultiArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(example_interfaces__msg__Int16MultiArray)) {
      return false;
    }
    ...
    example_interfaces__msg__Int16MultiArray * data =
      (example_interfaces__msg__Int16MultiArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!example_interfaces__msg__Int16MultiArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          example_interfaces__msg__Int16MultiArray__fini(&output->data[i]);
        }
        return false;
      }
    }
