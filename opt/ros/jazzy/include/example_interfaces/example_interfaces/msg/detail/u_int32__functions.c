...
example_interfaces__msg__UInt32__create(void)
{
  ...
  example_interfaces__msg__UInt32 * msg = (example_interfaces__msg__UInt32 *)allocator.allocate(sizeof(example_interfaces__msg__UInt32), allocator.state);
  if (!msg) {
    return NULL;
  }
...
example_interfaces__msg__UInt32__Sequence__init(example_interfaces__msg__UInt32__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(example_interfaces__msg__UInt32)) {
      return false;
    }
    data = (example_interfaces__msg__UInt32 *)allocator.zero_allocate(size, sizeof(example_interfaces__msg__UInt32), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  example_interfaces__msg__UInt32__Sequence * array = (example_interfaces__msg__UInt32__Sequence *)allocator.allocate(sizeof(example_interfaces__msg__UInt32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
example_interfaces__msg__UInt32__Sequence__are_equal(const example_interfaces__msg__UInt32__Sequence * lhs, const example_interfaces__msg__UInt32__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!example_interfaces__msg__UInt32__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  example_interfaces__msg__UInt32__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(example_interfaces__msg__UInt32)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(example_interfaces__msg__UInt32);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    example_interfaces__msg__UInt32 * data =
      (example_interfaces__msg__UInt32 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!example_interfaces__msg__UInt32__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          example_interfaces__msg__UInt32__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!example_interfaces__msg__UInt32__copy(
