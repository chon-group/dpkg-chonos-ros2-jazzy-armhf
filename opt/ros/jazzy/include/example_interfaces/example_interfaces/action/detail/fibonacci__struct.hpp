...
#ifndef _WIN32
# define DEPRECATED__example_interfaces__action__Fibonacci_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__example_interfaces__action__Fibonacci_SendGoal_Event __declspec(deprecated)
#endif
...
struct Fibonacci_SendGoal_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__example_interfaces__action__Fibonacci_SendGoal_Event
    std::shared_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__example_interfaces__action__Fibonacci_SendGoal_Event
    std::shared_ptr<example_interfaces::action::Fibonacci_SendGoal_Event_<ContainerAllocator> const>
...
using Fibonacci_SendGoal_Event =
  example_interfaces::action::Fibonacci_SendGoal_Event_<std::allocator<void>>;
...
struct Fibonacci_SendGoal
{
  ...
  using Event = example_interfaces::action::Fibonacci_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__example_interfaces__action__Fibonacci_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__example_interfaces__action__Fibonacci_GetResult_Event __declspec(deprecated)
#endif
...
struct Fibonacci_GetResult_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<example_interfaces::action::Fibonacci_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<example_interfaces::action::Fibonacci_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__example_interfaces__action__Fibonacci_GetResult_Event
    std::shared_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__example_interfaces__action__Fibonacci_GetResult_Event
    std::shared_ptr<example_interfaces::action::Fibonacci_GetResult_Event_<ContainerAllocator> const>
...
using Fibonacci_GetResult_Event =
  example_interfaces::action::Fibonacci_GetResult_Event_<std::allocator<void>>;
...
struct Fibonacci_GetResult
{
  ...
  using Event = example_interfaces::action::Fibonacci_GetResult_Event;
};
