...
rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__init(rcl_interfaces__srv__SetParametersAtomically_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Request)) {
      return false;
    }
  ...
  rcl_interfaces__srv__SetParametersAtomically_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Request)) {
      return false;
    }
...
rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__init(rcl_interfaces__srv__SetParametersAtomically_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Response)) {
      return false;
    }
  ...
  rcl_interfaces__srv__SetParametersAtomically_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Response)) {
      return false;
    }
    const size_t allocation_size =
...
rcl_interfaces__srv__SetParametersAtomically_Event__init(rcl_interfaces__srv__SetParametersAtomically_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rcl_interfaces__srv__SetParametersAtomically_Event__fini(msg);
    return false;
  }
  // request
  if (!rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__init(&msg->request, 0)) {
    rcl_interfaces__srv__SetParametersAtomically_Event__fini(msg);
    return false;
  }
  // response
  if (!rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__init(&msg->response, 0)) {
    rcl_interfaces__srv__SetParametersAtomically_Event__fini(msg);
    return false;
  }
  return true;
...
rcl_interfaces__srv__SetParametersAtomically_Event__fini(rcl_interfaces__srv__SetParametersAtomically_Event * msg)
{
  ...
  // request
  rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__fini(&msg->request);
  // response
  rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__fini(&msg->response);
}
...
rcl_interfaces__srv__SetParametersAtomically_Event__are_equal(const rcl_interfaces__srv__SetParametersAtomically_Event * lhs, const rcl_interfaces__srv__SetParametersAtomically_Event * rhs)
{
  ...
  // request
  if (!rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__are_equal(
  ...
  rcl_interfaces__srv__SetParametersAtomically_Event * output)
{
  ...
  // request
  if (!rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__SetParametersAtomically_Event * msg = (rcl_interfaces__srv__SetParametersAtomically_Event *)allocator.allocate(sizeof(rcl_interfaces__srv__SetParametersAtomically_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rcl_interfaces__srv__SetParametersAtomically_Event));
  bool success = rcl_interfaces__srv__SetParametersAtomically_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__init(rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__SetParametersAtomically_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Event)) {
      return false;
    }
    data = (rcl_interfaces__srv__SetParametersAtomically_Event *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__SetParametersAtomically_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rcl_interfaces__srv__SetParametersAtomically_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rcl_interfaces__srv__SetParametersAtomically_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__fini(rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rcl_interfaces__srv__SetParametersAtomically_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * array = (rcl_interfaces__srv__SetParametersAtomically_Event__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__SetParametersAtomically_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__destroy(rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rcl_interfaces__srv__SetParametersAtomically_Event__Sequence__are_equal(const rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * lhs, const rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__SetParametersAtomically_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rcl_interfaces__srv__SetParametersAtomically_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__SetParametersAtomically_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__SetParametersAtomically_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__SetParametersAtomically_Event * data =
      (rcl_interfaces__srv__SetParametersAtomically_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__SetParametersAtomically_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__SetParametersAtomically_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__SetParametersAtomically_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
