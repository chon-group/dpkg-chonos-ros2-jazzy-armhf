...
rcl_interfaces__srv__GetLoggerLevels_Request__init(rcl_interfaces__srv__GetLoggerLevels_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->names, 0)) {
    rcl_interfaces__srv__GetLoggerLevels_Request__fini(msg);
    return false;
  }
  return true;
}
...
rcl_interfaces__srv__GetLoggerLevels_Request__create(void)
{
  ...
  rcl_interfaces__srv__GetLoggerLevels_Request * msg = (rcl_interfaces__srv__GetLoggerLevels_Request *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rcl_interfaces__srv__GetLoggerLevels_Request));
  bool success = rcl_interfaces__srv__GetLoggerLevels_Request__init(msg);
  if (!success) {
...
rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__init(rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Request * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Request)) {
      return false;
    }
    data = (rcl_interfaces__srv__GetLoggerLevels_Request *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__GetLoggerLevels_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rcl_interfaces__srv__GetLoggerLevels_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rcl_interfaces__srv__GetLoggerLevels_Request__fini(&data[i - 1]);
      }
...
rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__fini(rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rcl_interfaces__srv__GetLoggerLevels_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * array = (rcl_interfaces__srv__GetLoggerLevels_Request__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__init(array, size);
  if (!success) {
...
rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__destroy(rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__are_equal(const rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * lhs, const rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rcl_interfaces__srv__GetLoggerLevels_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Request)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__GetLoggerLevels_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__GetLoggerLevels_Request * data =
      (rcl_interfaces__srv__GetLoggerLevels_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__GetLoggerLevels_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__GetLoggerLevels_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Request__copy(
...
rcl_interfaces__srv__GetLoggerLevels_Response__init(rcl_interfaces__srv__GetLoggerLevels_Response * msg)
{
  ...
  if (!rcl_interfaces__msg__LoggerLevel__Sequence__init(&msg->levels, 0)) {
    rcl_interfaces__srv__GetLoggerLevels_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Response * msg = (rcl_interfaces__srv__GetLoggerLevels_Response *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rcl_interfaces__srv__GetLoggerLevels_Response));
  bool success = rcl_interfaces__srv__GetLoggerLevels_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__init(rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Response * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Response)) {
      return false;
    }
    data = (rcl_interfaces__srv__GetLoggerLevels_Response *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__GetLoggerLevels_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rcl_interfaces__srv__GetLoggerLevels_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rcl_interfaces__srv__GetLoggerLevels_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__fini(rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rcl_interfaces__srv__GetLoggerLevels_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * array = (rcl_interfaces__srv__GetLoggerLevels_Response__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__destroy(rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__are_equal(const rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * lhs, const rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rcl_interfaces__srv__GetLoggerLevels_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Response)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__GetLoggerLevels_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__GetLoggerLevels_Response * data =
      (rcl_interfaces__srv__GetLoggerLevels_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__GetLoggerLevels_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__GetLoggerLevels_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rcl_interfaces__srv__GetLoggerLevels_Event__init(rcl_interfaces__srv__GetLoggerLevels_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rcl_interfaces__srv__GetLoggerLevels_Event__fini(msg);
    return false;
  }
  // request
  if (!rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__init(&msg->request, 0)) {
    rcl_interfaces__srv__GetLoggerLevels_Event__fini(msg);
    return false;
  }
  // response
  if (!rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__init(&msg->response, 0)) {
    rcl_interfaces__srv__GetLoggerLevels_Event__fini(msg);
    return false;
  }
  return true;
...
rcl_interfaces__srv__GetLoggerLevels_Event__fini(rcl_interfaces__srv__GetLoggerLevels_Event * msg)
{
  ...
  // request
  rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__fini(&msg->request);
  // response
  rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__fini(&msg->response);
}
...
rcl_interfaces__srv__GetLoggerLevels_Event__are_equal(const rcl_interfaces__srv__GetLoggerLevels_Event * lhs, const rcl_interfaces__srv__GetLoggerLevels_Event * rhs)
{
  ...
  // request
  if (!rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__are_equal(
  ...
  rcl_interfaces__srv__GetLoggerLevels_Event * output)
{
  ...
  // request
  if (!rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Event * msg = (rcl_interfaces__srv__GetLoggerLevels_Event *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rcl_interfaces__srv__GetLoggerLevels_Event));
  bool success = rcl_interfaces__srv__GetLoggerLevels_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__init(rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Event)) {
      return false;
    }
    data = (rcl_interfaces__srv__GetLoggerLevels_Event *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__GetLoggerLevels_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rcl_interfaces__srv__GetLoggerLevels_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rcl_interfaces__srv__GetLoggerLevels_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__fini(rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rcl_interfaces__srv__GetLoggerLevels_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * array = (rcl_interfaces__srv__GetLoggerLevels_Event__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__GetLoggerLevels_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__destroy(rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rcl_interfaces__srv__GetLoggerLevels_Event__Sequence__are_equal(const rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * lhs, const rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rcl_interfaces__srv__GetLoggerLevels_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__srv__GetLoggerLevels_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__GetLoggerLevels_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rcl_interfaces__srv__GetLoggerLevels_Event * data =
      (rcl_interfaces__srv__GetLoggerLevels_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__GetLoggerLevels_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__GetLoggerLevels_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__GetLoggerLevels_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
