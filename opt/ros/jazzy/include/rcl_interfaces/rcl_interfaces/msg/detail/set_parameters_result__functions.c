...
rcl_interfaces__msg__SetParametersResult__create(void)
{
...
rcl_interfaces__msg__SetParametersResult__Sequence__init(rcl_interfaces__msg__SetParametersResult__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(rcl_interfaces__msg__SetParametersResult)) {
      return false;
    }
  ...
  rcl_interfaces__msg__SetParametersResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rcl_interfaces__msg__SetParametersResult)) {
      return false;
    }
    ...
    rcl_interfaces__msg__SetParametersResult * data =
      (rcl_interfaces__msg__SetParametersResult *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__msg__SetParametersResult__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rcl_interfaces__msg__SetParametersResult__fini(&output->data[i]);
        }
        return false;
      }
    }
