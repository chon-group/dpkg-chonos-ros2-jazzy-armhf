...
#ifndef TEST_MSGS__SRV__DETAIL__ARRAYS__STRUCT_HPP_
#define TEST_MSGS__SRV__DETAIL__ARRAYS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__test_msgs__srv__Arrays_Request __attribute__((deprecated))
#else
# define DEPRECATED__test_msgs__srv__Arrays_Request __declspec(deprecated)
#endif
...
{
  using Type = Arrays_Request_<ContainerAllocator>;

  explicit Arrays_Request_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Arrays_Request_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : bool_values(_alloc),
    byte_values(_alloc),
    char_values(_alloc),
  ...
  // pointer types
  using RawPtr =
    test_msgs::srv::Arrays_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const test_msgs::srv::Arrays_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      test_msgs::srv::Arrays_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__test_msgs__srv__Arrays_Request
    std::shared_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_msgs__srv__Arrays_Request
    std::shared_ptr<test_msgs::srv::Arrays_Request_<ContainerAllocator> const>
  ...
  bool operator==(const Arrays_Request_ & other) const
  {
...
using Arrays_Request =
  test_msgs::srv::Arrays_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__test_msgs__srv__Arrays_Response __attribute__((deprecated))
#else
# define DEPRECATED__test_msgs__srv__Arrays_Response __declspec(deprecated)
#endif
...
{
  using Type = Arrays_Response_<ContainerAllocator>;

  explicit Arrays_Response_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
    {
  ...
  explicit Arrays_Response_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : bool_values(_alloc),
    byte_values(_alloc),
    char_values(_alloc),
    float32_values(_alloc),
  ...
  // pointer types
  using RawPtr =
    test_msgs::srv::Arrays_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const test_msgs::srv::Arrays_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      test_msgs::srv::Arrays_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      test_msgs::srv::Arrays_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__test_msgs__srv__Arrays_Response
    std::shared_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_msgs__srv__Arrays_Response
    std::shared_ptr<test_msgs::srv::Arrays_Response_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const Arrays_Response_ & other) const
  {
    if (this->bool_values != other.bool_values) {
      return false;
    }
...
// alias to use template instance with default allocator
using Arrays_Response =
  test_msgs::srv::Arrays_Response_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__test_msgs__srv__Arrays_Event __attribute__((deprecated))
#else
# define DEPRECATED__test_msgs__srv__Arrays_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct Arrays_Event_
{
  using Type = Arrays_Event_<ContainerAllocator>;

  explicit Arrays_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit Arrays_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::srv::Arrays_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::srv::Arrays_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::srv::Arrays_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::srv::Arrays_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::srv::Arrays_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::srv::Arrays_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::srv::Arrays_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::srv::Arrays_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    test_msgs::srv::Arrays_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const test_msgs::srv::Arrays_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      test_msgs::srv::Arrays_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      test_msgs::srv::Arrays_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__test_msgs__srv__Arrays_Event
    std::shared_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_msgs__srv__Arrays_Event
    std::shared_ptr<test_msgs::srv::Arrays_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const Arrays_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using Arrays_Event =
  test_msgs::srv::Arrays_Event_<std::allocator<void>>;
...
struct Arrays
{
  using Request = test_msgs::srv::Arrays_Request;
  using Response = test_msgs::srv::Arrays_Response;
  using Event = test_msgs::srv::Arrays_Event;
};
...
#endif  // TEST_MSGS__SRV__DETAIL__ARRAYS__STRUCT_HPP_
