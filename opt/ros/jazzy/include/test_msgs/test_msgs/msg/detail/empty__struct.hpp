...
#ifndef TEST_MSGS__MSG__DETAIL__EMPTY__STRUCT_HPP_
#define TEST_MSGS__MSG__DETAIL__EMPTY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__test_msgs__msg__Empty __attribute__((deprecated))
#else
# define DEPRECATED__test_msgs__msg__Empty __declspec(deprecated)
#endif
...
struct Empty_
{
  ...
  typedef DEPRECATED__test_msgs__msg__Empty
    std::shared_ptr<test_msgs::msg::Empty_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_msgs__msg__Empty
    std::shared_ptr<test_msgs::msg::Empty_<ContainerAllocator> const>
...
#endif  // TEST_MSGS__MSG__DETAIL__EMPTY__STRUCT_HPP_
