...
// IWYU pragma: private, include "test_msgs/msg/w_strings.hpp"
...
struct WStrings_
{
  ...
  explicit WStrings_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
    {
      ...
      std::fill<typename std::array<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, 3>::iterator, std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>>(this->array_of_wstrings.begin(), this->array_of_wstrings.end(), u"");
    }
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
  ...
  using _array_of_wstrings_type =
    std::array<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, 3>;
  _array_of_wstrings_type array_of_wstrings;
  using _bounded_sequence_of_wstrings_type =
    rosidl_runtime_cpp::BoundedVector<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>>>;
  _bounded_sequence_of_wstrings_type bounded_sequence_of_wstrings;
  using _unbounded_sequence_of_wstrings_type =
    std::vector<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>>>;
  ...
  Type & set__array_of_wstrings(
    const std::array<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, 3> & _arg)
  {
    this->array_of_wstrings = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_wstrings(
    const rosidl_runtime_cpp::BoundedVector<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>>> & _arg)
  {
    this->bounded_sequence_of_wstrings = _arg;
    return *this;
  }
  Type & set__unbounded_sequence_of_wstrings(
    const std::vector<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char16_t, std::char_traits<char16_t>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char16_t>>>> & _arg)
  {
