...
#ifndef TEST_MSGS__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
#define TEST_MSGS__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__test_msgs__msg__Defaults __attribute__((deprecated))
#else
# define DEPRECATED__test_msgs__msg__Defaults __declspec(deprecated)
#endif
...
struct Defaults_
{
  ...
  // pointer types
  using RawPtr =
    test_msgs::msg::Defaults_<ContainerAllocator> *;
  using ConstRawPtr =
    const test_msgs::msg::Defaults_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<test_msgs::msg::Defaults_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<test_msgs::msg::Defaults_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      test_msgs::msg::Defaults_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<test_msgs::msg::Defaults_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<test_msgs::msg::Defaults_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<test_msgs::msg::Defaults_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<test_msgs::msg::Defaults_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__test_msgs__msg__Defaults
    std::shared_ptr<test_msgs::msg::Defaults_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_msgs__msg__Defaults
    std::shared_ptr<test_msgs::msg::Defaults_<ContainerAllocator> const>
...
using Defaults =
  test_msgs::msg::Defaults_<std::allocator<void>>;
...
#endif  // TEST_MSGS__MSG__DETAIL__DEFAULTS__STRUCT_HPP_
