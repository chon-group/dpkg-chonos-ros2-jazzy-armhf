...
// IWYU pragma: private, include "test_msgs/msg/multi_nested.hpp"
...
struct MultiNested_
{
  ...
  using _bounded_sequence_of_arrays_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Arrays_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Arrays_<ContainerAllocator>>>;
  _bounded_sequence_of_arrays_type bounded_sequence_of_arrays;
  using _bounded_sequence_of_bounded_sequences_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BoundedSequences_<ContainerAllocator>>>;
  ...
  using _bounded_sequence_of_unbounded_sequences_type =
    rosidl_runtime_cpp::BoundedVector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>>;
  ...
  using _unbounded_sequence_of_arrays_type =
    std::vector<test_msgs::msg::Arrays_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Arrays_<ContainerAllocator>>>;
  _unbounded_sequence_of_arrays_type unbounded_sequence_of_arrays;
  using _unbounded_sequence_of_bounded_sequences_type =
    std::vector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BoundedSequences_<ContainerAllocator>>>;
  ...
  using _unbounded_sequence_of_unbounded_sequences_type =
    std::vector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>>;
  ...
  Type & set__bounded_sequence_of_arrays(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::Arrays_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Arrays_<ContainerAllocator>>> & _arg)
  {
    this->bounded_sequence_of_arrays = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_bounded_sequences(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BoundedSequences_<ContainerAllocator>>> & _arg)
  {
    this->bounded_sequence_of_bounded_sequences = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_unbounded_sequences(
    const rosidl_runtime_cpp::BoundedVector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, 3, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>> & _arg)
  {
    this->bounded_sequence_of_unbounded_sequences = _arg;
    return *this;
  }
  Type & set__unbounded_sequence_of_arrays(
    const std::vector<test_msgs::msg::Arrays_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Arrays_<ContainerAllocator>>> & _arg)
  {
    this->unbounded_sequence_of_arrays = _arg;
    return *this;
  }
  Type & set__unbounded_sequence_of_bounded_sequences(
    const std::vector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BoundedSequences_<ContainerAllocator>>> & _arg)
  {
    this->unbounded_sequence_of_bounded_sequences = _arg;
    return *this;
  }
  Type & set__unbounded_sequence_of_unbounded_sequences(
    const std::vector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>> & _arg)
  {
