...
// IWYU pragma: private, include "test_msgs/msg/unbounded_sequences.hpp"
...
struct UnboundedSequences_
{
  ...
  using _basic_types_values_type =
    std::vector<test_msgs::msg::BasicTypes_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BasicTypes_<ContainerAllocator>>>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    std::vector<test_msgs::msg::Constants_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Constants_<ContainerAllocator>>>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    std::vector<test_msgs::msg::Defaults_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Defaults_<ContainerAllocator>>>;
  ...
  Type & set__basic_types_values(
    const std::vector<test_msgs::msg::BasicTypes_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::BasicTypes_<ContainerAllocator>>> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const std::vector<test_msgs::msg::Constants_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Constants_<ContainerAllocator>>> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const std::vector<test_msgs::msg::Defaults_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<test_msgs::msg::Defaults_<ContainerAllocator>>> & _arg)
  {
