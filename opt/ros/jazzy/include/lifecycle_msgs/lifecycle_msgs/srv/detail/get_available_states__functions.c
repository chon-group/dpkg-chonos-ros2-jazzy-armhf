...
lifecycle_msgs__srv__GetAvailableStates_Request__Sequence__init(lifecycle_msgs__srv__GetAvailableStates_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Request)) {
      return false;
    }
  ...
  lifecycle_msgs__srv__GetAvailableStates_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Request)) {
      return false;
    }
    ...
    lifecycle_msgs__srv__GetAvailableStates_Request * data =
      (lifecycle_msgs__srv__GetAvailableStates_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lifecycle_msgs__srv__GetAvailableStates_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lifecycle_msgs__srv__GetAvailableStates_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__init(lifecycle_msgs__srv__GetAvailableStates_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Response)) {
      return false;
    }
  ...
  lifecycle_msgs__srv__GetAvailableStates_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Response)) {
      return false;
    }
    const size_t allocation_size =
    ...
    lifecycle_msgs__srv__GetAvailableStates_Response * data =
      (lifecycle_msgs__srv__GetAvailableStates_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lifecycle_msgs__srv__GetAvailableStates_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lifecycle_msgs__srv__GetAvailableStates_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
lifecycle_msgs__srv__GetAvailableStates_Event__init(lifecycle_msgs__srv__GetAvailableStates_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    lifecycle_msgs__srv__GetAvailableStates_Event__fini(msg);
    return false;
  }
  // request
  if (!lifecycle_msgs__srv__GetAvailableStates_Request__Sequence__init(&msg->request, 0)) {
    lifecycle_msgs__srv__GetAvailableStates_Event__fini(msg);
    return false;
  }
  // response
  if (!lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__init(&msg->response, 0)) {
    lifecycle_msgs__srv__GetAvailableStates_Event__fini(msg);
    return false;
  }
  return true;
...
void
lifecycle_msgs__srv__GetAvailableStates_Event__fini(lifecycle_msgs__srv__GetAvailableStates_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  lifecycle_msgs__srv__GetAvailableStates_Request__Sequence__fini(&msg->request);
  // response
  lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__fini(&msg->response);
}

bool
lifecycle_msgs__srv__GetAvailableStates_Event__are_equal(const lifecycle_msgs__srv__GetAvailableStates_Event * lhs, const lifecycle_msgs__srv__GetAvailableStates_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!lifecycle_msgs__srv__GetAvailableStates_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__are_equal(
...
bool
lifecycle_msgs__srv__GetAvailableStates_Event__copy(
  const lifecycle_msgs__srv__GetAvailableStates_Event * input,
  lifecycle_msgs__srv__GetAvailableStates_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!lifecycle_msgs__srv__GetAvailableStates_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!lifecycle_msgs__srv__GetAvailableStates_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lifecycle_msgs__srv__GetAvailableStates_Event * msg = (lifecycle_msgs__srv__GetAvailableStates_Event *)allocator.allocate(sizeof(lifecycle_msgs__srv__GetAvailableStates_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lifecycle_msgs__srv__GetAvailableStates_Event));
  bool success = lifecycle_msgs__srv__GetAvailableStates_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
lifecycle_msgs__srv__GetAvailableStates_Event__destroy(lifecycle_msgs__srv__GetAvailableStates_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lifecycle_msgs__srv__GetAvailableStates_Event__fini(msg);
...
bool
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__init(lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lifecycle_msgs__srv__GetAvailableStates_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Event)) {
      return false;
    }
    data = (lifecycle_msgs__srv__GetAvailableStates_Event *)allocator.zero_allocate(size, sizeof(lifecycle_msgs__srv__GetAvailableStates_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lifecycle_msgs__srv__GetAvailableStates_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lifecycle_msgs__srv__GetAvailableStates_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__fini(lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lifecycle_msgs__srv__GetAvailableStates_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * array = (lifecycle_msgs__srv__GetAvailableStates_Event__Sequence *)allocator.allocate(sizeof(lifecycle_msgs__srv__GetAvailableStates_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__destroy(lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__are_equal(const lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * lhs, const lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lifecycle_msgs__srv__GetAvailableStates_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
lifecycle_msgs__srv__GetAvailableStates_Event__Sequence__copy(
  const lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * input,
  lifecycle_msgs__srv__GetAvailableStates_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(lifecycle_msgs__srv__GetAvailableStates_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(lifecycle_msgs__srv__GetAvailableStates_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lifecycle_msgs__srv__GetAvailableStates_Event * data =
      (lifecycle_msgs__srv__GetAvailableStates_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lifecycle_msgs__srv__GetAvailableStates_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lifecycle_msgs__srv__GetAvailableStates_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lifecycle_msgs__srv__GetAvailableStates_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
