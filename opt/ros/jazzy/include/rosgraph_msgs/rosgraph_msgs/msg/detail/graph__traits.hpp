...
inline std::string to_yaml(const rosgraph_msgs::msg::Graph & msg)
{
  return rosgraph_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosgraph_msgs::msg::Graph>()
{
  return "rosgraph_msgs::msg::Graph";
}

template<>
inline const char * name<rosgraph_msgs::msg::Graph>()
{
  return "rosgraph_msgs/msg/Graph";
}
