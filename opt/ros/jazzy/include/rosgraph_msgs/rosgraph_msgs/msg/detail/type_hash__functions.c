...
rosgraph_msgs__msg__TypeHash__create(void)
{
...
rosgraph_msgs__msg__TypeHash__Sequence__init(rosgraph_msgs__msg__TypeHash__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(rosgraph_msgs__msg__TypeHash)) {
      return false;
    }
  ...
  rosgraph_msgs__msg__TypeHash__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rosgraph_msgs__msg__TypeHash)) {
      return false;
    }
