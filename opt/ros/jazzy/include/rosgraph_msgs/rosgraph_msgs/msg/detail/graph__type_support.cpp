...
{
  new (message_memory) rosgraph_msgs::msg::Graph(_init);
}

void Graph_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosgraph_msgs::msg::Graph *>(message_memory);
  typed_message->~Graph();
}

size_t size_function__Graph__nodes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rosgraph_msgs::msg::Node> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosgraph_msgs::msg::Node> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosgraph_msgs::msg::Node> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const rosgraph_msgs::msg::Node *>(
    get_const_function__Graph__nodes(untyped_member, index));
  auto & value = *reinterpret_cast<rosgraph_msgs::msg::Node *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<rosgraph_msgs::msg::Node *>(
    get_function__Graph__nodes(untyped_member, index));
  const auto & value = *reinterpret_cast<const rosgraph_msgs::msg::Node *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Graph_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosgraph_msgs::msg::Node>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rosgraph_msgs::msg::Graph, nodes),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Graph_message_members = {
  ...
  "Graph",  // message name
  1,  // number of fields
  sizeof(rosgraph_msgs::msg::Graph),
...
get_message_type_support_handle<rosgraph_msgs::msg::Graph>()
{
  return &::rosgraph_msgs::msg::rosidl_typesupport_introspection_cpp::Graph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosgraph_msgs, msg, Graph)() {
  return &::rosgraph_msgs::msg::rosidl_typesupport_introspection_cpp::Graph_message_type_support_handle;
}
