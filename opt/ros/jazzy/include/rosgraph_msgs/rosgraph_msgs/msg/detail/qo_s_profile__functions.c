...
rosgraph_msgs__msg__QoSProfile__create(void)
{
...
rosgraph_msgs__msg__QoSProfile__Sequence__init(rosgraph_msgs__msg__QoSProfile__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(rosgraph_msgs__msg__QoSProfile)) {
      return false;
    }
  ...
  rosgraph_msgs__msg__QoSProfile__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(rosgraph_msgs__msg__QoSProfile)) {
      return false;
    }
