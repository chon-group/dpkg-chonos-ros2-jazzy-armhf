...
builtin_interfaces__msg__Time__Sequence__init(builtin_interfaces__msg__Time__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(builtin_interfaces__msg__Time)) {
      return false;
    }
  ...
  builtin_interfaces__msg__Time__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(builtin_interfaces__msg__Time)) {
      return false;
    }
    ...
    builtin_interfaces__msg__Time * data =
      (builtin_interfaces__msg__Time *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!builtin_interfaces__msg__Time__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          builtin_interfaces__msg__Time__fini(&output->data[i]);
        }
        return false;
      }
    }
